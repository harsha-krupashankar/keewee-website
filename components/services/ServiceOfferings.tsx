...
export default function ServiceOfferings({ doc }: { doc: ServicePage }) {
  if (!doc.offerings?.length) return null;
    ...
    <section className="py-14 md:py-16">
      <Container>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {doc.offerings.map((offering, i) => (
            <Reveal
              key={offering.title}
              // Cap the stagger: some service pages have thirteen offerings and
              // the last card should not wait half a second to appear.
