          ...
          <div className="relative z-10 grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <Reveal>
              ...
              <h2 className="my-3 max-w-[560px] font-display text-[30px] font-extrabold leading-none tracking-[-0.035em] text-ink sm:text-[40px] lg:text-[52px]">
                30 minutes. We&apos;ll tell you exactly what&apos;s broken.
              </h2>
              <p className="mb-5 max-w-[520px] font-body text-base font-semibold leading-relaxed text-green-deep">
                Your messaging, website, content and funnel — pulled apart
                and handed back as specific, prioritized fixes you can act
                on. Whether you hire us or not.
              </p>
            ...
            <Reveal delay={120} className="rounded-[18px] bg-ink p-6 text-paper shadow-[0_12px_30px_rgba(28,27,25,0.2)]">
